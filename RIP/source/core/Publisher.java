...
//					netWorkAddress, String mask, String defaultGetWay, String interf, int metric
					object.put("netWorkAddress",table.getNetWorkAddress());
					object.put("mask",table.getMask());
					object.put("defaultGetWay",table.getDefaultGetWay());
					object.put("interf",table.getInterf());
